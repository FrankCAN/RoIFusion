...
def parse_args():
    ...
    parser.add_argument('--cfg', default='/home/chencan/Phd_Projects/02_detection/3DSSD_z_backup/3DSSD_car_test/configs/kitti/3dssd/3dssd.yaml', help='Config file for training')
    parser.add_argument('--restore_model_path', default='/home/chencan/Phd_Projects/02_detection/3DSSD_z_backup/3DSSD_car_test/lib/core/log/2020-06-21 05:44:46.185383', help='Restore model path e.g. log/model.ckpt [default: None]')
    parser.add_argument('--img_list', default='test', help='Train/Val/Trainval/test list')
    parser.add_argument('--split', default='testing', help='Dataset split')

    # some evaluation threshold
    parser.add_argument('--cls_threshold', default=0.3, help='Filtering Predictions')
    parser.add_argument('--no_gt', default=True, help='Used for test set')
