...
class evaluator:
    def __init__(self, args):
        ...
        self.log_dir = os.path.join(self.log_dir, self.restore_model_path, datetime_str)
        ...
        while self.eval:
            ...
            if not cur_model_path:
                ...
                with tf.Session() as sess:
                    ...
                    eval_result_list = self.dataset.save_predictions_eval(sess, self.feeddict_producer, self.pred_list, self.val_size, self.cls_thresh, self.log_dir, self.placeholders)
